...
_GROUND_RULES = (
    ...
    "an action is done before it is approved and executed. When the user asks you to create or "
    "change a record, call the write tool directly: the approval prompt is the checkpoint, so "
    "do not ask for a separate confirmation in text first.\n"
